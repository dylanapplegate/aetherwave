...
namespace Aetherwave
{
    ...
    public class GalleryStartup : MonoBehaviour
    {
        void Start()
        {
            Debug.Log("🚀 Gallery Startup - Configuring ImageDisplayManager...");
            ...
            if (rawImage != null)
            {
                ...
                if (imageManager == null)
                {
                    ...
                    Debug.Log("✅ ImageDisplayManager added to: " + rawImage.name);
                }
                else
                {
                    Debug.Log("✅ ImageDisplayManager already configured");
                }
            }
            else
            {
                Debug.LogError("❌ No RawImage found for gallery display!");
            }
        }
    }
}
