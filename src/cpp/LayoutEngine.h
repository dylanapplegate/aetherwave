...
private:
    ...
    // Layout change tracking to prevent redundant calculations
    struct LayoutState {
        int windowWidth, windowHeight;
        size_t textureCount;
        std::vector<std::pair<int, int>> textureDimensions; // width, height pairs
        LayoutMode mode;
        int displayIndex;
    ...
    LayoutState lastCalculatedState;
